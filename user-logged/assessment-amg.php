...
<body>
    ...
    <section class="container my-4">
        <div class="container bg-secondary-subtle rouded-4 p-5 mb-5 text-dark rounded-4 shadow">
            <div class="row gx-0">
                <div class="col-md-1 d-none d-md-block">
                    <span class="badge rounded-pill border border-light bg-custom-color2 px-3 py-2 custom-text-color">Quiz 1</span>
                </div>
                <div class="col-md-1 d-none d-md-block">
                    <span class="badge rounded-pill border border-light bg-success-subtle px-3 py-2 text-success">Quiz 2</span>
                </div>
                <div class="col-md-1 d-none d-md-block">
                    <span class="badge rounded-pill border border-light bg-success-subtle px-3 py-2 text-success">Quiz 3</span>
                </div>
            </div>

            <div class="my-sm-4">
                <h5 class="fw-semibold">Category: <span>Animation Motion Graphics</span></h5>
            </div>
            ...
            <div class="container p-0">
                ...
                $sql = "SELECT * FROM `questions` WHERE specialization='AMG'";
                ...
                echo '<form action="assessment-amg.php#divOne" method="post" enctype="multipart/form-data">';

                foreach (array_slice($questions, 0, 20) as $question) {
                    echo '<div class="my-4">';
                ...
                $insert_query = "UPDATE `students_acc` SET amg_score = '$grade' WHERE userid = $session_id" or die("Query Failed");
                ...
                $percentage = ($amg_score / count($questions)) * 100;
                ...
                <div class="container-fluid overlay" id="divOne">>
                    <div class="modal-content">
                        ...
                        <hr>
                        <p class="lead">
                            Thank you for taking the AMG assessment. This assessment will help you to determine whether a specialization
                            in Animation and Motion Graphics is the right fit for you. We hope that this assessment will be a useful tool
                            in your journey towards choosing the right specialization and achieving success in your career.
                            Please click the button to proceed with the assessment.
                        </p>
                        <hr>
                        <a class="btn btn-primary" href="assessment-wmad.php">Proceed</a>
                    </div>
                </div>
