    ...
    <section class="container my-4">
        <div class="container bg-secondary-subtle rouded-4 p-5 text-dark rounded-4 shadow">
            <div class="row gx-0">
                ...
                <div class="col-md-1 d-none d-md-block">
                    <span class="badge rounded-pill border border-light bg-custom-color2 px-3 py-2 custom-text-color">Quiz 2</span>
                </div>
                <div class="col-md-1 d-none d-md-block">
            ...
            <div class="my-4">
                <h5 class="fw-semibold">Category: <span>Web and Mobile Application Development</span></h5>
            </div>
            ...
            <div class="container px-3">
                ...
                $sql = "SELECT * FROM `questions` WHERE specialization='WMAD'";
                ...
                echo '<form action="assessment-wmad.php#divOne" method="post" enctype="multipart/form-data">';
                ...
                $insert_query = "UPDATE `students_acc` SET wmad_score = '$grade' WHERE userid = $session_id" or die("Query Failed");
                ...
                $percentage = ($wmad_score / count($questions)) * 100;
                ...
                <div class="container-fluid overlay" id="divOne">>
                    <div class="modal-content">
                        ...
                        <hr>
                        <p class="lead">
                            Thank you for taking the WMAD assessment. This assessment will help you to determine whether a specialization
                            in web and mobile application development is the right fit for you. We hope that this assessment will be a
                            useful tool in your journey towards choosing the right specialization and achieving success in your career.
                            Please click the button to proceed with the assessment.
                        </p>
                        <hr>
                        <a class="btn btn-primary" href="assessment-smp.php">Proceed</a>
                    </div>
                </div>
