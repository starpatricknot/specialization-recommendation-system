...
<body>
  ...
  <section class="container-fluid p-5 my-5 bg-custom-img">
    ...
    <div class="container ftr-bnft shadow-lg bg-white rounded-4 p-5  d-none d-sm-block hidden">
      <h4 class="display-5 text-dark py-2 hoverable-about" id="about">Feature Benefits</h4>
      <div class="content">
    ...
    <div class="container accordion accordion-flush d-md-none d-sm-block hidden" id="accordionExample">
